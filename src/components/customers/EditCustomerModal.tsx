...
interface EditCustomerModalProps {
  ...
  onSave: (customerId: string, data: EditCustomerData) => Promise<void>;
...
export const EditCustomerModal = ({ open, onOpenChange, onSave, customer }: EditCustomerModalProps) => {
  ...
  const handleChange = (field: keyof EditCustomerData, value: string) => {
